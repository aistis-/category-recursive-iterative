...
nginx::resource::vhost { 'category.dev':
  ensure      => present,
  server_name => [
    'category.dev',
    'www.category.dev',
...
nginx::resource::location { 'category.dev-php':
  ensure              => 'present',
  index_files         => [
    'app_dev.php',
    'app.php',
...
nginx::resource::vhost { 'xhprof.category.dev':
  ensure       => present,
  server_name  => ['xhprof.category.dev'],
...
nginx::resource::location { 'xhprof.category.dev-php':
  ensure              => 'present',
  index_files         => ['index.php', 'index.html'],
  vhost               => 'xhprof.category.dev',
  location            => '~ \.php$',
  proxy               => undef,
  try_files           => ['$uri', '$uri/', '/index.php?$args'],
  www_root            => '/var/www/vendor/facebook/xhprof/xhprof_html/',
